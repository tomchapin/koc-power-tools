...
var DispReport = {
  ...
  parseGiftReport : function(rpts){
    ...
    for(var i=0; i<rpts.length; i++){
		...
		if(rpts[i].subject.innerHTML.indexOf('Neues Geschenk erhalten!') >= 0 && rpts[i].sender.innerHTML.indexOf('Kingdoms Of Camelot') >= 0){
			rpts[i].checkbox.firstChild.checked = true;
		}
		if(rpts[i].subject.innerHTML.indexOf('Nuovo Regalo ricevuto!') >= 0 && rpts[i].sender.innerHTML.indexOf('Kingdoms Of Camelot') >= 0){
			rpts[i].checkbox.firstChild.checked = true;
		}
		if(rpts[i].subject.innerHTML.indexOf('Yeni Hediye Alindi!') >= 0 && rpts[i].sender.innerHTML.indexOf('Kingdoms Of Camelot') >= 0){
			rpts[i].checkbox.firstChild.checked = true;
		}
		if(rpts[i].subject.innerHTML.indexOf('¡Nuevo regalo recibido!') >= 0 && rpts[i].sender.innerHTML.indexOf('Kingdoms Of Camelot') >= 0){
			rpts[i].checkbox.firstChild.checked = true;
		}
	}
