...
var DispReport = {
  ...
  parseGiftReport : function(rpts){
    ...
    for(var i=0; i<rpts.length; i++){
		...
		if(rpts[i].subject.innerHTML.indexOf('New Gift Received!')||('Neues Geschenk erhalten!')||('Nuovo Regalo ricevuto!')||('Yeni Hediye Alindi!')||('¡Nuevo regalo recibido!') >= 0 && rpts[i].sender.innerHTML.indexOf('Kingdoms Of Camelot') >= 0){
