...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  mainPop = new CPopup ('ptmain', Options.ptWinPos.x, Options.ptWinPos.y, 800,750, Options.ptWinDrag, 
      function (){
        tabManager.hideTab();
...
/*******  DEF  ******/  
  ...
  displayCityStats : function (){
    ...
    m += '<TABLE class=ptTab width=100%><TR align=center>\
        ...
        <TD width=16%><SPAN id=ptttr_stone><B>Stone:</b><BR>'+ addCommasInt(t.stats.stone) +'</span></td>\
...
Tabs.Marches = {
  ...
  /***   Incoming SUBTAB  ***/
      showIncoming : function (){
        ...
        var icon, status, FROM, cityname, FROMmight;
...
var AudioAlert = {
  ...
  sound : function(tf){
   var t = AudioAlert;
	...
	if(t.alert)
	setTimeout(function(){t.sound(false)},20000);
  },
