...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  logit ("* KpC Power Tools - Deutsch - by PDX - Version: "+ Version +" geladen!");
...
//    t.show ();
  ...
  show : function (){
    ...
    m = '<CENTER>'+ strButton20('Zurücksetzten', 'id=ptwref') +'</center><TABLE cellspacing=0 cellpadding=0 class=ptTabPad align=center>';
...
*/
  ...
  show : function (){
    ...
    if (t.state == null){
      if (getMyAlliance()[0] == 0) {
        t.cont.innerHTML = '<BR><BR><CENTER><blink>Du musst in einer Allianz sein um dieses Feature zu nutzen!</blink></center>';
        t.state = 1;
        return;
      }
      var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
          ...
          <TR><TD class=xtab> </td><TD class=xtab> Allianz Name: &nbsp;</td><TD class=xtab>&nbsp;</td>\
            ...
            <TD class="xtab ptErrText"><SPAN id=ptallErr></span></td></tr><TR><TD class=xtab></td>\
             ...
             <TD class=xtab><INPUT align=right id=allGotoPage type=submit value="Seite" />\
               <INPUT align=right id=idPageNum type="text" value='+t.curPage+' size=4 />\
             <span align=left id=idMaxPageNum ></span></td>\
...
<b>ETA</b>: <i>estimated time of arrival</i> | voraussichtliche Ankunftszeit!</td>\
  ...
  eventPlayerSubmit : function (){
    ...
    document.getElementById('allListOut').innerHTML = '<BR><BR><CENTER>Durchsuche Leaderboard nach Spieler Daten...</center>';
  ...
  eventGotPlayerOnlineList : function (rslt){
    ...
    for (k in t.playerList){
      ...
      m += '<TR '+ cl +'valign=top><TD>'+ u.genderAndName +'</td><TD align=right>'+ addCommasInt(u.might) +'</td>\
          ...
          <TD align=center><A target="_tab" href="http://www.facebook.com/profile.php?id='+ u.fbuid +'">Profil</a></td>\
          <TD><SPAN onclick="PTpd(this, '+ u.userId +')"><A>Details</a> &nbsp; <BR></span><SPAN onclick="PTpl2(this, \''+ u.userId +'\')"><A>Leaderboard</a><br></span><SPAN onclick="PCplo(this, '+ u.userId +')"><A>Login</a></span></td></tr>';
    }
    m += '</table></div>';
  ...
  gotPlayerLastLogin : function (rslt, span){
    ...
    if (lastLogin) {
      m = '<span style="color:black">Login: '+lastLogin+'</span>';
    } else {
...
notify ({errorMsg:'AJAX error'});
  ...
  var s = Tabs.Search;
    span.onclick = '';
    span.innerHTML = "suche login date ...";
  ...
  gotPlayerDetail : function (rslt, span){
    ...
    var m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Details:</b> &nbsp; </td><TD><u>Allianz</u> '+ a +' &nbsp; <u>Städte</u> '
          + u.cities +' &nbsp; <u>Bevölkerung</u>: '+ u.population +'</td></tr><TR><TD></td><TD><u>Provinzen</u> ';
  ...
  eventSubmit : function (){
    ...
    if (t.aName.length < 3){
      document.getElementById('ptallErr').innerHTML = '<span style="color:red"><blink>Mind. 3 Zeichen eingeben!</blink></span>';
      return;
    }
    var myA = getMyAlliance ();
    document.getElementById('altInput').innerHTML = '';
  ...
  eventListSubmit : function (){
    var t = Tabs.AllianceList;
    var myA = getMyAlliance ();
    document.getElementById('allListOut').innerHTML = '<BR><BR><CENTER>Durchsuche Leaderboard nach Allianz Informationen...</center>';
    if (myA[0]!=0  ) {
       t.curPage=1;
       ...
       document.getElementById('allListOut').innerHTML = '<blink>Du musst in einer Allianz sein um dieses Feature zu nutzen!</blink>';
    }
  },
  ...
  eventGotAllianceList : function (rslt){
    ...
    var m = '<DIV class=ptstat>Ergebniss: <B>"'+ t.aName +'"</b></div>\
    <TABLE><TR style="font-weight:bold"><TD class=xtab>Allianz Name</td><TD class=xtab>Rank</td><TD class=xtab>Spieler</td>\
  ...
  gotoPage : function (){
    ...
    if (t.MaxPage < 0 ) {
      document.getElementById('allListOut').innerHTML = 'Allianzen als erstes auflisten';
      return;
    }
    if (t.MaxPage < 0 || val > t.MaxPage || val < 1) {
      document.getElementById('allListOut').innerHTML = 'Seite Nummer existiert nicht!';
      return;
    }
    t.curPage = val;
    document.getElementById('allListOut').innerHTML = '<BR><BR><CENTER>Durchsuche Leaderboard nach Allianz Informationen...</center>';
  ...
  eventGotOtherAlliancePage : function (rslt){
    ...
    document.getElementById('idMaxPageNum').innerHTML = 'von ' + t.MaxPage;

    var m = '<div style="overflow:auto; height:556px;width:564px;"><TABLE><thead><TR style="font-weight:bold"> \
        <th class=xtab>Allianz Name</th><th class=xtab>Rang</th><th class=xtab>Spieler</th>\
        <th align=right class=xtab>Macht</th><th class=xtab>Diplomatie</th><th class=xtab></th></tr></thead><tbody>';
    document.getElementById('allListOut').innerHTML = m;
    ...
    m += '</tbody></TABLE><div style="font-weight:bold"; height:20px;width:560px; ><span> <a onclick="PTalClickPrev(-1)"> [Top 10] </a><a onclick="PTalClickPrev(10)"> [-10] </a><a onclick="PTalClickPrev(5)"> [-5] </a><a onclick="PTalClickPrev(1)"> [zurück] </a> \
...
return 0;        
    ...
    for (var i=0; i<t.dat.length; i++){
		m += '<TR style="max-height:30px"><TD class=xxtab>'+ t.dat[i][0] +'</td><TD align=right class=xxtab>'+ addCommasInt(t.dat[i][1])
         +'</td><TD align=center class=xxtab>'+ t.dat[i][3] +'</td><TD class=xxtab>'+ t.dat[i][7]                    
         +'</td><TD class=xxtab>'+ (t.dat[i][9]?'<SPAN class=boldDarkGreen><blink>ONLINE</blink></span>':'') +'</td><TD class=xxtab><SPAN onclick="PCplo(this, \''+ t.dat[i][11] +'\')"><A>Login</a></span></td><TD align=right class=xxtab><DIV onclick="ptGotoMap('+ t.dat[i][5] +','+ t.dat[i][6] +')"><A>'+ t.dat[i][5] +','+ t.dat[i][6] +'</a></div>'+ (t.dat[i][10]?''
         +'</td><TD align=center class=xxtab><SPAN>'+ (t.dat[i][10]>0?timestr(t.dat[i][10],1):'NA') +'</span>':'<SPAN>NA</span>') +'</td>\
            <TD align=right class=xxtab style="padding-right:20px;">'+ t.dat[i][8].toFixed(2) +'</td>\
         </td><TD  nowrap class=xxtab>'+ officerId2String(t.dat[i][2]) +'<td class=xxtab>'+ t.dat[i][4] +'<td></tr>';
		/*
      m += '<TR style="max-height:30px"><TD class=xxtab>'+ t.dat[i][0] +'</td><TD align=right class=xxtab>'+ addCommasInt(t.dat[i][1])
         +'</td><TD align=center class=xxtab>'+ t.dat[i][3] +'</td><TD class=xxtab>'+ officerId2String(t.dat[i][2])                       
         +'</td><TD class=xxtab>'+ (t.dat[i][9]?'<SPAN class=boldDarkGreen><blink>ONLINE</blink></span>':'') +'</td><TD class=xxtab>'+ t.dat[i][7] +'</td><TD align=right class=xxtab><SPAN onclick="PCplo(this, \''+ t.dat[i][11] +'\')"><A>Login</a></span>'
         +'</td><TD align=center class=xxtab><DIV onclick="ptGotoMap('+ t.dat[i][5] +','+ t.dat[i][6] +')"><A>'+ t.dat[i][5] +','+ t.dat[i][6] +'</a></div></td>\
            <TD align=right class=xxtab style="padding-right:20px;">'+ t.dat[i][8].toFixed(2) +'</td>\
         </td><TD  nowrap class=xxtab>'+ (t.dat[i][10]?'<SPAN>'+ (t.dat[i][10]>0?timestr(t.dat[i][10],1):'NA') +'</span>':'<SPAN>NA</span>') +'<td class=xxtab>'+ t.dat[i][4] +'<td></tr>';
*/
    }
...
//new CtableToText('tabAllMembers').toText();
    ...
    var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
      ...
      <TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" class=clickable><A><DIV>Spieler</div></a></td>\
        ...
        <TD id=clickCol3 onclick="PTalClickSort(this)" class=clickable><A><DIV>#</a></div></td>\
		        <TD id=clickCol7 onclick="PTalClickSort(this)" class=clickable><A><DIV>Stadt Name</a></div></td>\
        ...
        <TD id=clickCol8 onclick="PTalClickSort(this)" class=clickable><A><DIV>ETA</a></div></td>\
       <TD id=clickCol10 onclick="PTalClickSort(this)" class=clickable><A><DIV>Entf.</a></div></td>\
	    <TD id=clickCol2 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Rang</a></div></td>\
         <TD id=clickCol4 onclick="PTalClickSort(this)" class=clickable><A><DIV>Level</a></div></td></tr></thead>\
  ...
  displayPlayer : function (allName,rslt){
    ...
    var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
      ...
      <TD class=xtab width=80% align=center>Login: <SPAN id=lastlogin>'+  rslt.playerInfo.lastLogin+'</span></td><TD class=xtab align=right></td></tr></table></div>\
      <div style="max-height:470px; height:470px; overflow-y:auto;"><TABLE id=tabAllMembers align=center cellpadding=0 cellspacing=0><THEAD style="overflow-y:hidden;">\
<TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" class=clickable><A><DIV>Spieler</div></a></td>\
        <TD id=clickCol1 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Macht</a></div></td>\
        <TD id=clickCol3 onclick="PTalClickSort(this)" class=clickable><A><DIV>#</a></div></td>\
		<TD id=clickCol7 onclick="PTalClickSort(this)" class=clickable><A><DIV>Stadt Name</a></div></td>\
        <TD id=clickCol9 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Online</a></div></td>\
         <TD class=clickable><DIV><A>Login</a></div></td>\
        <TD id=clickCol5 onclick="PTalClickSort(this)" class=clickable><A><DIV>Koord</a></div></td>\
        <TD id=clickCol8 onclick="PTalClickSort(this)" class=clickable><A><DIV>ETA</a></div></td>\
        <TD id=clickCol10 onclick="PTalClickSort(this)" class=clickable><A><DIV>Entf.</a></div></td>\
		<TD id=clickCol2 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Rang</a></div></td>\
    <TD id=clickCol4 onclick="PTalClickSort(this)" class=clickable><A><DIV>Level</a></div></td></thead>\
      <TBODY id=allBody style="background-color:#ffffff;"></tbody></table></div>';
    document.getElementById('allListOut').innerHTML = m;//style="top:670px; left:0px; position:absolute;
    document.getElementById('altInput').innerHTML = '<HR><TABLE width=100% cellpaddding=0><TR align=center>\
        <TD class=xtab>Entfernung von: &nbsp; X: <INPUT size=2 type=text id=plyrX /> Y: <INPUT size=2 type=text id=plyrY /> <span id=dmcoords></span></td></tr></table>';
  ...
  eventGetMembers : function (aid){
    var t = Tabs.AllianceList;
    document.getElementById('allListOut').innerHTML = '<BR><BR><CENTER>Durchsuche Leaderboard nach Spieler Informationen...</center>';
  ...
  fetchAllianceList : function (allianceName, myAid, notify) {   // at least 3 chars :)
    ...
    function combineResults (rsltA, rsltM, notify){
      if (!rsltA.ok){
        if (rsltA.msg.indexOf("keine Allianz unter")!=0 || !rsltM.ok){
          notify (rsltA);
          return;
        }
        rsltA.ok = true;
...
Tabs.F = {
  ...
  init : function (div){
   ...
   var citySelect = '   <SELECT id=fakeCity>';
       ...
       citySelect += '</select>';
    var m = '<TABLE><TR><TD align=right>Späh Angriff: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    m = '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
        ...
        <DIV style="height:650px; max-height:650px; overflow-y:auto; overflow-x:hidden"><DIV class=ptstat>TRUPPEN INFORMATION</div><TABLE align=center cellpadding=1 cellspacing=0>\
        <TR align=center><TD class=xtab></td><TD class=xtabHL colspan=5><B>KOSTEN</b></td><TD class=xtabHL colspan=7><B>STATISTIK</b></td><TD class=xtabHL><B>VER.</b></td></tr>\
        <TR valign=bottom align=right><TD class=xtab></td><TD class=xtabHL>Futter</td><TD class=xtabH>Holz</td><TD class=xtabH>Stein</td>\
        <TD class=xtabH>Erz</td><TD class=xtabH>Volk</td><TD class=xtabHL>Macht</td><TD class=xtabH>Leb.</td><TD class=xtabH>Angr.</td><TD class=xtabH>Def.</td><TD class=xtabH>Gesch.</td><TD class=xtabH>Ent.</td><TD class=xtabH>Trag.</td>\
...
var crestreq = { 3:{1101:4, 1102:2, 1103:1},
 ...
 m += '<DIV class=ptstat>WAPPEN INFORMATION</div><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR CLASS="xtabH">\
        <TD class=xtab></TH>\
        <TD class=xtabHL><b>Vorraussetzung 1 (Vorhanden)</b></TD>\
        <TD class=xtabHL><b>Vorraussetzung 2 (Vorhanden)</b></TD>\
        <TD class=xtabHL><b>Vorraussetzung 3 (Vorhanden)</b></TD>\
      </TR>\
    <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=14></td></tr>';
    rownum = 0;
    for(k in crestreq){
 ...
 m += '</TABLE>';
  //End crest info
    //Link info
    m += '<DIV class=ptstat>NÜTZLICHE LINKS</div>';
    m += '<table width="700" border="0" cellspacing="0" cellpadding="0">';
    m += '<tr><td width="57"><b>Nr.</b></td>';
    m += '<td width="343"><b><center>Thema</center></b></td>';
    m += '<td width="156"><b><center>Quelle</center></b></td></tr>';
    m += '<tr><td><b># 1</b></td>';
    m += '<td><center><a href=http://www.kingdoms-of-camelot.de/archives/angriffe-auf-wildnisgebiete-strategie target=_blank>Angriffe auf Wildnisgebiete - Strategie</a></center></td>';
  m += '<td><center><a href=http://kingdoms-of-camelot.de target=_blank>kingdoms-of-camelot.de</a></center></td></tr>';
    m += '<tr><td><b># 2</b></td>';
    m += '<td><center><a href="http://www.kingdoms-of-camelot.de/archives/category/barbaren-lager" target="_blank">Angriffe auf Babaren Lager</a></center></td>';
    m += '<td><center><a href="http://kingdoms-of-camelot.de" target="_blank">kingdoms-of-camelot.de</a></center></td></tr>';
    m += '<tr><td><b># 3</b></td>';
    m += '<td><center><a href="http://koc.wikia.com/wiki/Crests" target="_blank">Wappen Suche</a></center></td>';
    m += '<td><center><a href="http://koc.wiki.com" target="_blank">koc.wiki.com</a></center></td></tr>';
    m += '<tr><td><b># 4</b></td>';
    m += '<td><center><a href="href=http://www.kingdoms-of-camelot.de/archives/category/wildnis" target="_blank">Wildniss Angriffe Allgemein</a></center></td>';
    m += '<td><center><a href="http://kingdoms-of-camelot.de" target="_blank">kingdoms-of-camelot.de</a></center></td></tr>';
  m += '<tr><td><b># 5</b></td>';
...
ETA = <i>estimated time of arrival</i> | voraussichtliche Ankunftszeit</center></div>';
    ...
    m += '<DIV class=ptstat>WEITERE INFORMATIONEN</div>Kingdom of Camelot Client Version: '+ KOCversion +'<HR><a href="http://userscripts.org/scripts/show/98323" target="_blank">Power Tools - Deutsch</a> <BR>German Version by <a href="http://userscripts.org/users/297645/scripts" target="_blank">PDX</a> <BR>Version: <SPAN class=boldRed> '+ Version +' </span><BR> ';
    if (DEBUG_BUTTON)
...
Tabs.Options = {
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
       <TR><TD colspan=2><B><u>Power Tools - Einstellung</u></b></td></tr>\
 ...
 <TR><TD colspan=2><span style=\"font-size:10px; color:#555; line-height:18px; \"><font color=#600000><B><u>Wichtig</u></b></font>: max. 8 Stunden eintragen! sonst spamst du den Allianz Chat!</span></td></tr>\
  ...
  <TR><TD><INPUT id=togChatWhisper type=checkbox /></td><TD>Flüster Text <SPAN class=boldRed>Rot</span> anzeigen!</td></tr>\
      ...
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Erweiterte Allianz Berichte.</td></tr>\
        ...
        <TR><TD colspan=2><BR><BR><B><u>Bug Fix</u></b></td></tr>\
...
estimateETA : function(fromCityID,dist,troopSpeed,horseTF) { // Need Relief Station Levels to estimate transport, reinf, or reassign times.
...
Tabs.Train = {
  ...
  init : function (div){
    ...
    s = "<DIV id=trainTopSelect>\
      <DIV class=ptstat>Hier kannst du Truppen Ausbilden und Mauer Verteidigung Bauen</div><DIV style='height:10px'></div><DIV class=ptentry>\
      <DIV style='text-align:center; margin-bottom:10px;'>Heiligtum: &nbsp; <span id=ptspeedcity></span></div>\
    ...
    if (matTypeof(uc[8]) == 'object'){
      for (k in uc[8]){  // check building requirement
        ...
        if (b.maxLevel < uc[8][k][1]){
          t.stats.MaxTrain = 0;
          t.stats.Limiter = '<blink>Gebäude/Upgrade';
          break;
        }
      }
    }
  ...
  changeDefSelect : function (){
    ...
    if (matTypeof(uc[8]) == 'object'){
      for (k in uc[8]){  // check building requirement
        ...
        if (b.maxLevel < uc[8][k][1]){
          t.stats.MaxDefTrain = 0;
          t.stats.DefLimiter = '<blink>Gebäude/Upgrade</blink>';
          break;
        }
      }
    }
...
﻿    str += '<TR><TD class=ptstat>Truppen</td></tr>';
    ...
    <td colspan="6"><b><u>Ansicht Einstellung</b></u></td></tr><tr>\
    <td width="20"><INPUT type=CHECKBOX id=ptIncWachturm'+ (Options.includeWachturm?' CHECKED':'') +'></td>\
    <td colspan="5"><span class="xtab">Wachturm Anzeigen! <SPAN class=boldRed>(Verteidigung/Versteckt)</span></span></td>\
    </tr><tr>\<td height="22"><INPUT type=CHECKBOX id=ptIncNahrung'+ (Options.includeNahrung?' CHECKED':'') +'></td><td width="43">Oben</td>\
   <td width="193" rowspan="2">Nahrungs Verbrauch Anzeigen!</td>\
      <td width="100" rowspan="2"><center></center></td><td width="22" rowspan="2"><INPUT type=CHECKBOX id=ptIncRessis'+ (Options.includeRessis?' CHECKED':'') +'></td>\
  ...
  <tr><td colspan="6">&nbsp;</td></tr><tr><td><INPUT type=CHECKBOX id=ptoverOriginal'+ (Options.includeCity?' CHECKED':'') +'></td>\
    ...
    <td colspan="5">Overflow erlauben <SPAN class=boldRed>(keine Scrollbalken!)</span> | Schriftgröße: '+ htmlSelector ({9:9, 10:10, 11:11, 12:12, 14:14}, Options.overviewFontSize, 'id=ptoverfont') +'</td>\
  </tr></table>';
      str += "</table></div>";
...
Tabs.Marches = {
  ...
  init : function (div){
    ...
    unsafeWindow.undefend = t.butundefend;
    unsafeWindow.cancelMarch = t.butcancelmarch;

    t.cont = div;
    t.cont.innerHTML = '<TABLE class=ptTab align=center><TR><TD><INPUT class=pbSubtab ID=ptmrchSubA type=submit value=Angriffe></td>\
          <TD><INPUT class=pbSubtab ID=ptmrchSubM type=submit value=Märsche></td>\
          <TD><INPUT class=pbSubtab ID=ptmrchSubR type=submit value=Verstärkung></td></tr></table><HR class=ptThin>\
      <DIV id=ptMarchOutput style="margin-top:10px; background-color:white; height:500px; max-width:740px; overflow:scroll;"></div>';
  ...
  hide : function (){
    var t = Tabs.Marches;
    clearTimeout (t.displayTimer);
    mainPop.div.style.height = 750 + 'px';
  },
  ...
  show : function (){
    ...
    if (t.curTabName == 'R')
      ...
      t.showIncoming();
   mainPop.div.style.height = 500 + 'px';
  },
 ...
 /***   Incoming SUBTAB  ***/
      showIncoming : function (){
        ...
        var cityname;
        var FROMmight;
        //var z = '<TD><INPUT id=TEST type=submit value="TEST"></td>';
        //z += '<TD><INPUT id=TEST2 type=submit value="TEST2"></td>';
         var z = '<TABLE id=pdincoming cellSpacing=10 width=100% height=0% class=pbTab><div class=ptstat>ANGRIFFE AUF DIE HEILIGTÜMER</div>';
       ...
       for (k in Seed.queue_atkinc) {
          if(Seed.queue_atkinc.length !=0){
           //if  (parseInt(Seed.queue_atkinc[k]["marchType"]) ==3 || parseInt(Seed.queue_atkinc[k]["marchType"])==4){
                   ...
                   if (Seed.queue_atkinc[k]["destinationUnixTime"] < (now) || marchStatus == 8) marchstatus = "returning";
                   else marchstatus = "going";  
                   
                   if (marchStatus == 2) destinationUnixTime = now - Seed.queue_atkinc[k]["arrivalTime"]; //- now;
                   if (marchStatus == 1) destinationUnixTime = Seed.queue_atkinc[k]["arrivalTime"] - now;
                   else  destinationUnixTime = Seed.queue_atkinc[k]["arrivalTime"] - now;
                   marchtime = timestr(destinationUnixTime, true)
                                      
                   if (marchType != 3 && marchType !=4){
                     for (players in Seed.players){
                       if (('u'+Seed.queue_atkinc[k]["fromPlayerId"]) == players){ FROM = Seed.players[players]["n"];}
                     }
                   }
                   else {
                   for (players in Seed.players){
                ...
                if (Seed.queue_atkinc[k]["unit0Count"] > 0 && marchstatus == "going") z += '<TD???'+ addCommas(Seed.queue_atkinc[k]["unit0Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit0Return"] > 0 && marchstatus == "returning") z += '<TD>???: '+ addCommas(Seed.queue_atkinc[k]["unit0Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit1Count"] > 0 && marchstatus == "going") z += '<TD>Versoger: '+ addCommas(Seed.queue_atkinc[k]["unit1Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit1Return"] > 0 && marchstatus == "returning") z += '<TD>Versorger: '+ addCommas(Seed.queue_atkinc[k]["unit1Return"]) +'</td>';
                
                if (Seed.queue_atkinc[k]["unit2Count"] > 0 && marchstatus == "going") z += '<TD>Miliz: '+ addCommas(Seed.queue_atkinc[k]["unit2Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit2Return"] > 0 && marchstatus == "returning") z += '<TD>Miliz: '+ addCommas(Seed.queue_atkinc[k]["unit2Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit3Count"] > 0 && marchstatus =="going") z += '<TD>Späher: '+ addCommas(Seed.queue_atkinc[k]["unit3Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit3Return"] > 0 && marchstatus == "returning") z += '<TD>Späher: '+ addCommas(Seed.queue_atkinc[k]["unit3Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit4Count"] > 0 && marchstatus =="going") z += '<TD>Lanzen: '+ addCommas(Seed.queue_atkinc[k]["unit4Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit4Return"] > 0 && marchstatus == "returning") z += '<TD>Lanzen: '+ addCommas(Seed.queue_atkinc[k]["unit4Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit5Count"] > 0 && marchstatus =="going") z += '<TD>Schwerter: '+ addCommas(Seed.queue_atkinc[k]["unit5Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit5Return"] > 0 && marchstatus == "returning") z += '<TD>Schwerter: '+ addCommas(Seed.queue_atkinc[k]["unit5Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit6Count"] > 0 && marchstatus =="going") z += '<TD>Bogen: '+ addCommas(Seed.queue_atkinc[k]["unit6Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit6Return"] > 0 && marchstatus == "returning") z += '<TD>Bogen: '+ addCommas(Seed.queue_atkinc[k]["unit6Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit7Count"] > 0 && marchstatus =="going") z += '<TD>Kav: '+ addCommas(Seed.queue_atkinc[k]["unit7Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit7Return"] > 0 && marchstatus == "returning") z += '<TD>Kav: '+ addCommas(Seed.queue_atkinc[k]["unit7Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit8Count"] > 0 && marchstatus =="going") z += '<TD>S-Kav: '+ addCommas(Seed.queue_atkinc[k]["unit8Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit8Return"] > 0 && marchstatus == "returning") z += '<TD>S-Kav: '+ addCommas(Seed.queue_atkinc[k]["unit8Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit9Count"] > 0 && marchstatus =="going") z += '<TD>Wagen: '+ addCommas(Seed.queue_atkinc[k]["unit9Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit9Return"] > 0 && marchstatus == "returning") z += '<TD>Wagen: '+ addCommas(Seed.queue_atkinc[k]["unit9Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit10Count"] > 0 && marchstatus =="going") z += '<TD>Ballis: '+ addCommas(Seed.queue_atkinc[k]["unit10Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit10Return"] > 0 && marchstatus == "returning") z += '<TD>Ballis: '+ addCommas(Seed.queue_atkinc[k]["unit10Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit11Count"] > 0 && marchstatus =="going") z += '<TD>Ram: '+ addCommas(Seed.queue_atkinc[k]["unit11Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit11Return"] > 0 && marchstatus == "returning") z += '<TD>Ram: '+ addCommas(Seed.queue_atkinc[k]["unit11Return"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit12Count"] > 0 && marchstatus =="going") z += '<TD>Katas: '+ addCommas(Seed.queue_atkinc[k]["unit12Count"]) +'</td>';
                if (Seed.queue_atkinc[k]["unit12Return"] > 0 && marchstatus == "returning") z += '<TD>Katas: '+ addCommas(Seed.queue_atkinc[k]["unit12Return"]) +'</td>';
                
                if (marchType == 3 && Seed.queue_atkinc[k]["unts"]["u3"] > 0) z += '<TD>Späher: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u3"]) +'</td>';
                if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u1"] > 0) z += '<TD>Versorger: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u1"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u2"] > 0) z += '<TD>Miliz: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u2"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u3"] > 0) z += '<TD>Späher: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u3"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u4"] > 0) z += '<TD>Lanzen: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u4"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u5"] > 0) z += '<TD>Schwerter: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u5"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u6"] > 0) z += '<TD>Bogen: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u6"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u7"] > 0) z += '<TD>Kav: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u7"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u8"] > 0) z += '<TD>S-Kav: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u8"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u9"] > 0) z += '<TD>Wagen: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u9"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u10"] > 0) z += '<TD>Ballis: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u10"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u11"] > 0) z += '<TD>Ram: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u11"]) +'</td>';
                   if (marchType == 4 && Seed.queue_atkinc[k]["unts"]["u12"] > 0) z += '<TD>Katas: '+ addCommas(Seed.queue_atkinc[k]["unts"]["u12"]) +'</td>';
                   z += '</tr>';
              }
        // }
     }
  ...
  /***   MARCHES SUBTAB  ***/
   ...
   var icon, status, type
     ...
     for (var c=0; c< Seed.cities.length;c++) {
     		...
     		var cityTo;    
    		number=0;	
    		if (Seed.queue_atkp[cityID].length !=0) m+= '<TR><TD colspan=5 style=\'background: #99CCFF;\' align=center><div class=ptstat><B>' + cityname +': </b></div></td></tr>';
...
if (type =="returning" && marchType != 2) marchType = 100;
 ...
 if (type =="returning" && marchType == 2 && Seed.queue_atkp[cityID][k]["destinationUnixTime"] < (now) && marchStatus != 2) marchType = 100;
  				    ...
  				    switch (marchType) {
  					    ...
  					    case 3: icon="http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/scouting.jpg";status="Spähen";break;
  					    case 4: icon="http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/attacking.jpg";status="Angriff";break;
  					    case 5: icon="http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/transporting.jpg";status="Neu zuornden";break;
  					    case 100: icon="http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/returning.jpg";status="Rückmarsch";break;
  					    case 102: icon="http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/reinforce.jpg";status="Lagernd";break;
  				    } 
  				    ...
  				    if (Seed.queue_atkp[cityID][k]["knightId"] !=0){
  				     ...
  				     m += '<TR><TD>'+ number +'</td>';
  				    if (status=="Lagernd" && !t.isMyself(Seed.queue_atkp[cityID][k].fromPlayerId))
						m += '<TD><A onclick="r8x6Home('+ marchID +')"><img src='+ icon +'></a></td>';
  				    else if(status=='Rückmarsch')
  				    ...
  				    if (knight != null)  m += '<TD>Ritter: '+ knight +'</td>';
  					...
  					else if (Seed.queue_atkp[cityID][k]["toCityId"] ==0) m +='<TD>Barbaren Lager Lvl: '+Seed.queue_atkp[cityID][k]["toTileLevel"]+'</td>';
  ...
  ﻿  ﻿  ﻿  ﻿      if (Seed.queue_atkp[cityID][k]["unit12Return"] > 0 && type == "returning") m += '<TD>Katas﻿  : '+ addCommas(Seed.queue_atkp[cityID][k]["unit12Return"]) +'</td>';
		...
		m += '</table>';
	m += '<span style=\"font-size:10px; color:#555; line-height:18px; \"><font color=#600000><B><u>Hinweis</u></b></font>: Klick auf die Marschbilder um die Truppen zurückzurufen!!</span>';
    ...
    butcancelmarch: function(marchID){
    	 var t = Tabs.Marches;
    	 	 var params = unsafeWindow.Object.clone(unsafeWindow.g_ajaxparams);
			 alert("Marsch Zurückgerufen! Marsch ID: "+marchID);
    	 	 params.mid = marchID;
     	 	 for (var c=0; c<Cities.numCities; c++){
...
// TODO: Only allow 'send home' if troops are here now  (marchStatus = ?)              
  ...
  butRecall : function (marchId){
    var t = Tabs.Marches;
	alert("Rückruf erfolgreich! Marsch ID: "+marchId);
  ...
  butSendHome : function (marchId){
    var t = Tabs.Marches;
    alert("Truppen wurden zurück geschickt! Marsch ID: "+marchId);
